...
$mod_strings = array (
  ...
  'LBL_ALLOW_OUTBOUND_GROUP_USAGE_DESC' => 'Lorsque cette option est sélectionnée, les informations "From" nom et adresse associée avec ce compte mail de groupe apparaitront en option pour le champ "From" lorsque les utilisateurs qui ont accès à cette boite composeront un email.',
  'LBL_RE' => 'RE:',
  'LBL_FIND_OPTIMUM_KEY' => 'f',
  'LBL_MAILBOX_DEFAULT' => 'INBOX',
  'LBL_TEST_BUTTON_KEY' => 't',
  'LBL_ASSIGN_TEAM' => 'Assigner les emails entrants à l&#39;équipe',
  ...
  'ERR_INI_ZLIB' => 'Impossible de désactiver temporairement la compression Zlib. "Tester Paramétrage" a échoué.',
  'ERR_MAILBOX_FAIL' => 'Ne peux accéder à aucune Boîte Mail.',
  'ERR_NO_IMAP' => 'Livrairie IMAP non trouvée. Merci de résoudre le problème avant de poursuivre le paramétrage des Emails',
  'ERR_NO_OPTS_SAVED' => 'Pas de paramètres optimaux sauvegardés avec votre boîte Emails Entrants. Merci de revoir le paramètrage',
  ...
  'LBL_AUTOREPLY' => 'Réponse Automatique',
  'LBL_AUTOREPLY_HELP' => 'Sélectionnez une réponse automatique de notification de réception.',
  ...
  'LBL_CASE_MACRO_DESC2' => 'Vous pouvez choisir n&#39;importe quelle chaîne de caractères comme Mot clé , mais vous devez conserver le <b>"%1"</b>.',
  ...
  'LBL_CREATE_NEW_GROUP' => '--Créer un groupe de Boîtes Mail en sauvegardant--',
  ...
  'LBL_ASSIGN_TO_GROUP_FOLDER_DESC' => 'Assigner un compte mail à un dossier de groupe active l import automatique des emails.',
  ...
  'LBL_HOME' => 'Accueil',
  'LBL_LIST_MAILBOX_TYPE' => 'Utilisation du compte mail',
  'LBL_LIST_NAME' => 'Nom:',
  ...
  'LBL_PERSONAL_MODULE_NAME' => 'Compte mail personnel',
  ...
  'LBL_MODULE_NAME' => 'Compte mail Groupe',
  'LBL_BOUNCE_MODULE_NAME' => 'Compte mail de gestion de Bounce',
  ...
  'LBL_ASSIGN_TO_TEAM_DESC' => 'L&#39;équipe sélectionnée a accès au compte mail. Si un Dossier de Groupe est sélectionné, l&#39;équipe désignée pour le Dossier de Groupe surcharge l&#39;&quipe sélectionnée.',
  'LBL_SSL' => 'Activer SSL',
  'LBL_STATUS' => 'Statut',
  ...
  'LBL_TEST_WAIT_MESSAGE' => 'Un instant s&#39;il vous plaît...',
  ...
  'LBL_WARN_IMAP_TITLE' => 'Avertissement IMAP',
  ...
  'LNK_LIST_CREATE_NEW_GROUP' => 'Nouvelle boîte Email',
  ...
  'LBL_IS_GROUP' => 'Groupe',
  'LBL_ENABLE_AUTO_IMPORT' => 'Importer automatiquement les mails',
  ...
  'LBL_WARNING_CHANGING_AUTO_IMPORT_WITH_CREATE_CASE' => 'L&#39;import automatique des mails doit être activée pour la création automatique de tickets.',
);
