...
$mod_strings = array (
  ...
  'LBL_SOURCE_JSONPHP' => 'JSON.php - PHP скрипт за конвертиране от JSON формат от Michal Migurski.',
  'LBL_SOURCE_JSON' => 'JSON.js - Анализаторите JSON parser и JSON stringifier в JavaScript.',
  'LBL_SOURCE_HTTP_WEBDAV_SERVER' => 'HTTP_WebDAV_Server - Изпълнение на WEB DAV сървър в PHP.',
  'LBL_SOURCE_JS_O_LAIT' => 'JavaScript O Lait - Библиотека за множество модули и компоненти, за подобряване на JavaScript от Jan-Klaas Kollhof.',
  ...
  'LBL_SOURCE_JSMIN' => 'JSMin - филтър, който премахва коментари, ненужни файлове и интервали от JavaScript.',
