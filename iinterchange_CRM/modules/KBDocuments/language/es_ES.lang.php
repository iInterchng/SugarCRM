...
$mod_strings = array (
  ...
  'LBL_DATEENTERED' => 'Fecha de Creación:',
  ...
  'LBL_SYNTAX_CHEAT_SHEET' => '<B>Ayuda sobre la Sintaxis de las Consultas:</b><P>
        <ol>
...
<li>Una comilla simple (\') será buscada como tal, y no como una agrupación.</li></ol>
        ...
        <p><b>Ejemplo: </b><br><br>
        Para buscar todos los artículos con las palabras "Sugar" o "CRM" que deban tener las palabras "Base de Conocimiento" y "genial," pero que no deben de tener las palabras "demo" o "tiempo pasado", introduzca la siguiente cadena:<br>&nbsp;&nbsp;&nbsp;&nbsp;Sugar CRM +"Base de Conocimiento" +genial -demo -"tiempo pasado"</p><br>

        <p><b>Notas: </b><br>
<ol><li>La capitalización de las letras no se tendrá en cuenta.</li>
<li>Los espacios y las comas son ambos delimitadores aceptados.</li>
<li>No ponga un espacio entre los signos más (+) o menos (-) y las palabras a las que afectan.</li></ol>
</p>',
