...
$mod_strings = array (
  ...
  'LBL_SMW_WELCOME' => 'Добро пожаловать в студию!</h2><br><b>
Пожалуйста, выберите модуль.',
  'LBL_SMA_WELCOME' => '<h2>Редактирование модуля</h2>
Что именно вы хотите сделать с модулем?<br><b>
Пожалуйста, выберите необходимое действие.',
  ...
  'LBL_MB_WELCOME' => '<h2>История</h2>
<br> История позволяет вам просмотреть предыдущие сохраненные версии редактируемого в данный момент файла. Вы можете сравнить текущую версию с предыдущей, а также восстановить предыдущую версию. Восстановленный файл станет вашим рабочим файлом. Вы должны опубликовать его для того, чтобы он стал доступен всем пользователям.<br> Что бы вы хотели сделать?<br>
<b> Пожалуйста, выберите необходимую опцию.</b>',
  ...
  'LBL_SYNCP_WELCOME' => 'Пожалуйста, укажите адрес портала, который вы хотите обновить и нажмите кнопку "Далее".
Вам будет предложено ввести имя пользователя и пароль. 
Пожалуйста, введите необходимые данные и нажмите кнопку "Начать синхронизацию".',
  ...
  'LBL_SP_UPLOADSTYLE' => 'Нажмите на кнопку "Обзор" и выберите необходимый файл таблицы стилей для загрузки.
В следующий раз при синхронизации портала будет использована указанная таблица стилей.',
