...
$mod_strings = array (
  ...
  'LBL_SUGAR_FIELDS_STAGE' => 'Sugar-mezők (kattintson a tételre színpadhoz adáshoz)',
  'LBL_SUGAR_BIN_STAGE' => 'Sugar-lomtár (kattintson a tételre színpadhoz adáshoz)',
  'LBL_VIEW_SUGAR_FIELDS' => 'Sugar-mezők megtekintése',
  'LBL_VIEW_SUGAR_BIN' => 'Sugar-lomtár megjeneítése',
  ...
  'LBL_SW_WELCOME' => 'Üdvözöljük a Stúdióban!
...
',
  ...
  'LBL_SMW_WELCOME' => 'Üdvözöljük a Stúdióban!

Kérjük, válasszon az alábbi modulokból.',
  'LBL_SMA_WELCOME' => 'Modul szerkesztése
Mit akar csinálni ebben a modulban?
Kérjük válassza ki, milyen tevékenységet szeretne végezni.',
  ...
  'LBL_MB_WELCOME' => 'Előzmények

Az Előzmények opció lehetővé teszi, hogy visszanézze a korábban létrehozott fájlokat. Szükség esetén összehasonlíthatja és vissza is állíthatja a korábbi verzióra. Visszaállítás esetén a program visszatér ahhoz a fájlhoz, amellyel épp dolgozik. 
Kérem, válasszon az alábbi lehetőségek közül.',
  ...
  'LBL_EC_WELCOME' => 'Egyéni mezőszerkesztő

Szerkeszthet egy már meglévő egyedi mezőt, létrehozhat egy újat vagy törölheti is az ideiglenes tárhelyből.',
  ...
  'LBL_SM_WELCOME' => 'Előzmény

Kérem, jelölje ki azt a fájlt amit meg szeretne tekinteni!',
  ...
  'LBL_DELETE_MODULE' => 'Vegye ki a modult
a csoportból',
  ...
  'LBL_SP_WELCOME' => 'Üdvözöljük a Sugar Portál Stúdió menüjében. Ebben a részben szerkesztheti vagy szinkronizálhatja a portál példányait.
Kérjük, válasszon a az alábbi lehetőségek közül:',
  'LBL_SP_SYNC' => 'Portál szinkronizálás',
  'LBL_SYNCP_WELCOME' => 'Kérem a frissítéshez gépelje be az URL címet a megfelelő helyre majd kattintson a "Mehet" gombra.
Ezzel meg fog jelenni egy bekérő ablak a felhasználónévhez és jelszóhoz.
Kérjük gépelje be a Sugar rendszerben megadott felhasználónevét és jelszavát, majd kattintson a Szinkronizálás Kezdése gombra.',
  ...
  'LBL_SP_UPLOADSTYLE' => 'Kattintson a Tallóz gombra és válassza ki a feltölteni kívánt stíluslapot.
Ezt követően a rendszer már az új stíluslappal fog megjelenni.',
