...
',
  ...
  'LBL_FILTERS_HELP_DESC' => '<b>Задаване на критерии за филтриране:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b> , за който да се дефинират критерии за филтриране. По подразбиране е избран основният модул за справката (най-горе в структурата с модули). <br/><br/>
	За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула . Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b> .<br/><br/>
	2) За добавяне на нови филтри, изберете поле от списъка с полетата в секция <b>Налични полета</b> . За търсене, въведете заглавие на полето във формата за търсене.<br/><br/>
	Можете да избирате произволен брой полета за филтриране от повече от един модул, представени в секцията <b>Свързани модули</b> .<br/><br/>
	3) Изберете <b>И</b> или <b>ИЛИ</b> съответно за включване на всички или само на избрани филтри за търсене на резултатите за справката.<br/><br/>
	4) [Optional] За вмъкване на нови групи с филтри, натиснете <b>Добавяне на група за филтриране</b> . Броят на групите за филтриране, както и на филтрите в отделните групи е неограничен.<br/><br/>
	5) [Optional] Изберете опцията Run-time за предоставяне на възможност на потребителите да използват филтъра за персонализиране на резултатите при преглед на справката.',
  'LBL_GROUP_BY_HELP_DESC' => '<b>Определяне на колони за групиране:</b><br></br>1) Изберете модул от секция <b>Свързани модули</b> , за който да се групират записите в справката. По подразбиране е избран основният модул за справката (най-горе в структурата с модули). <br/><br/>
	За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b> .<br/><br/>
	2) Изберете поле от секция <b>Налични полета</b> ,с което да се групират записите в справката. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/>
	Можете да избирате произволен брой полета за групиране от повече от един модул, представени в секцията <b>Свързани модули</b> . Избирането на голям брой условия за групиране, може да доведе до проблеми при разчитането на справката.<br/><br/>
	За промяна на поредността на полетата, преместете полето с влачене до желаната позиция.  Промени в подредбата се отразяват върху начина за визуализиране на резултатите.<br/><br/>  Matrix справката може да съдържа не повече от 3 условия за групиране.',
  'LBL_DISPLAY_COLS_HELP_DESC' => '<b>Избиране на колони за показване:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b> , за който да се визуализират данни в справката. По подразбиране е избран основният модул, посочен при изпълнение на стъпка \'Изберете модул\' .<br/><br/>
	За избиране на полета от свързан модул, натиснете върху заглавието на модула. Имате възможност за избиране и на допълнителни модули, асоциирани със свързани модули. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b> .<br/><br/>
	2) Изберете поле от секция <b>Налични полета</b> за визуализиране на информация от записите в системата, въведена в полето. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/>
	Можете да избирате произволен брой допълнителни полета от повече от един модул, представени в секцията <b>Свързани модули</b> . Броят на полетата в справката е неограничен. Избирането на голям брой полета може да доведе до по-бавно изпълнение и евентуални проблеми при разчитането на справката.<br/><br/>
	За промяна на поредността на полетата, преместете полето с влачене до желаната позиция. Промени в подредбата се отразяват върху поредността на колоните при визуализиране на резултатите.',
  'LBL_DISPLAY_SUMMARY_HELP_DESC' => '<b>Избиране на колони за обобщаване:</b><br/><br/>1) Изберете модул от секция <b>Свързани модули</b> , за който да се обобщават данните в справката. По подразбиране е избран основният модул за справката (най-горе в структурата с модули).<br/><br/>
	За избиране на свързан модул, натиснете върху заглавието на модула. За преглед на допълнителни модули, асоциирани със свързания, натиснете иконката до заглавието на модула. Избраният модул определя полетата, които да се визуализират в секция <b>Налични полета</b> .<br/><br/>
	2) Изберете поле от секция <b>Налични полета</b> за обобщаване в справката. За търсене, въведете заглавие на полето във формата за търсене.<br/><br/>
	Можете да избирате произволен брой допълнителни полета за обобщаване от повече от един модул, представени в секцията <b>Свързани модули</b> .<br/><br/>Matrix справката може да съдържа повече от едно поле за визуализиране на multiple values within a single cell.',
