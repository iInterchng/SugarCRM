...
$mod_strings = array (
  ...
  'LBL_REPORT_HIDE_CHART' => 'Cacher le graphique',
  ...
  'LBL_HIDE_COLUMNS' => 'Cacher les colonnes',
  ...
  'LBL_YOU_HAVE_NO_SAVED_REPORTS_' => 'Aucun rapport sauvegardé.',
...
',
  ...
  'LBL_FILTERS_HELP_DESC' => '<b>Pour définir des Filtres :</b><br/><br/>1) Sélectionnez le module dans l&#39;onglet <b>Modules liés</b> pour lequel vous souhaitez définir des filtres. Par défaut, c&#39;est le premier module (au sommet de l&#39;arborescence) qui est sélectionné. <br/><br/>
	Vous pouvez sélectionner un sous module (noeud fils dans l&#39;arborescence) en cliquant sur le module. Déplier le noeud pour voir les modules additionnels concernant le module relatif. Le module sélectionné détermine quels seront les champs reportable qui apparaitront dans l&#39;onglet <b>Champs Disponibles</b>.<br/><br/>
	2) Sélectionnez un champ dans l&#39;onglet <b>Champs Disponibles</b> pour l&#39;ajouter aux filtres. Vous pouvez aussi rechercher le champ en tapant directement son nom dans dans le champ de saisie de l&#39;onglet.<br/><br/>
	Après avoir choisi le nombre de champs désiré dans le module sélectionné dans l&#39;onglet <b>Modules liés</b>, vous pouvez choisir un module différent duquel vous pouvez sélectionner autant de champ que nécessaire pour être utilisé comme filtre.<br/><br/>
	3) Choisir <b>ET</b> ou bien <b>OU</b> pour choisir si tous les filtres ou bien n&#39;importe quel filtre, respectivement, sont utilisés pour rechercher les résultats dans le rapport.<br/><br/>
	4) [Optionnel] Cliquez sur <b>Ajouter un groupe de filtre</b> pour créer un groupe de filtres. Vous pouvez créer autant de groupes de filtre et autant de filtres dans chaque groupe que vous le voulez.<br/><br/>
	5) [Optionnel] Sélectionnez l&#39;option d&#39;interactif pour chaque filtre afin que l&#39;utilisateur puisse se servir de ce filtre pour personnaliser plus tard les résultats du rapport lors de la visualisation.',
  'LBL_GROUP_BY_HELP_DESC' => '<b>Pour définir des Liaisons :</b><br></br>1) Cliquer sur un module dans l&#39;onglet <b>Modules liés</b> que vous voulez utiliser pour regrouper les enregistrements dans votre rapport. Par défaut, le module principal (à la racine de l&#39;arborescence) est sélectionné. <br/><br/>
	Vous pouvez sélectionner un module lié (Noeud fils dans l&#39;arborescence) en cliquant sur le module. Déplier le noeud pour voir les modules additionels relatifs au module lié. Le module sélectionné détermine quel champ reportable apparait dans l&#39;onglet <b>Champ Disponibles</b>.<br/><br/>
	2) Cliquer sur un champ dans l&#39;onglet <b>Champ Disponibles</b> pour grouper les enregistrements à partir du champ dans votre rapport. Vous pouvez aussi rechercher le champ en tapant son nom dans la zone de saisie de l&#39;onglet.<br/><br/>
	Après avoir sélectionné les champs du module sélectionné dans l&#39;onglet <b>Modules liés</b>, vous pouvez choisir un autre module depuis lequel vous pouvez choisir n&#39;importe quel nombre de champs afin de grouper les enregistrements. Attention toutefois, choisir trop de champs rend le rapport d&#39;autant moins lisible.<br/><br/>
	Vous pouvez intervertir l&#39;ordre des champs par simple drag and drop.  Changer cet ordre impact la façon dont les résultats seront affichés.<br/><br/>  Pour un rapport matrice, vous pouvez utiliser un maximum de trois champs pour grouper vos enregistrements.',
  'LBL_DISPLAY_COLS_HELP_DESC' => '<b>Pour choisir les colonnes à afficher :</b><br/><br/>1) Cliquer sur un module dans l&#39;onglet <b>Modules liés</b> que vous voulez utiliser pour en afficher les champs dans votre rapport. Par défaut, le module principal (à la racine de l&#39;arborescence) que vous avez choisi à l&#39;étape &#39;Selection du Module&#39; est sélectionné.<br/><br/>
	Vous pouvez choisir les champs d&#39;un module lié (Noeud enfant dans l&#39;arborescence) en cliquant sur le module. Les modules liés aux modules liés au module principal peuvent eux aussi être sélectionnés. Le module que vous sélectionnez détermine quel champ reportable apparait dans l&#39;onglet <b>Champs Disponibles</b>.<br/><br/>
	2) Cliquer sur le champ dans l&#39;onglet <b>Champs Disponibles</b> pour afficher la donnée contenue dans le champ dans votre rapport. Vous pouvez aussi rechercher le champ en tapant directement son nom dans la zone de saisie dans l&#39;onglet.<br/><br/>
	Après avoir sélectionné le nombre de champs désiré du module choisi dans l&#39;onglet <b>Modules liés</b>, vous pouvez choisir un module différent duquel vous pourrez ajouter des champs additionnels. Vous pouvez sélectionner autant de champ que vous le voulez, mais le rapport sera géneré plus lentement et deviendra d&#39;autant moins lisible que vous ajouterez de champs additionnels.<br/><br/>
	Vous pouvez changer l&#39;ordre des champs par simple drag and drop. Changer l&#39;ordre des champs change l&#39;ordre dans lequel seront affichées les colonnes du résultat.',
  'LBL_DISPLAY_SUMMARY_HELP_DESC' => '<b>Choisir l&#39;affichage des lignes de regroupement :</b><br/><br/>1) Sélectionnez un module dans l&#39;onglet <b>Modules Liés</b> que vous souhaitez utiliser pour les lignes de regroupement de vos rapport. Par défaut, le module principal (Racine de l&#39;arborescence) est sélectionné.<br/><br/>
	Vous pouvez sélectionner un module lié (Noeud enfant dans l&#39;arborescence) en cliquant dessus. Dépliez le noeud pour voir les modules additionnels relatifs au modules liés. Le module que vous sélectionnez détermine quels seront les champs qui apparaitront dans l&#39;onglet <b>Champs Disponibles</b>.<br/><br/>
	2) Cliquer sur un champ dans l&#39;onglet <b>Champs Disponibles</b> pour sélectionner des lignes de regroupement pour votre rapport. Vous pouvez aussi rechercher le champ en tapant directement dans la zone de saisie de l&#39;onglet.<br/><br/>
	Après avoir choisi n&#39;importe quel nombre de champs dans le module sélectionné dans l&#39;onglet <b>Modules Liés</b>, vous pouvez choisir un module différent duquel vous pouvez là aussi sélectionner des champs additionnels pour le résumé de votre rapport.<br/><br/>Pour les rapport matrice, vous pouvez choisir plus d&#39;un champ pour afficher plusieurs valeurs au sein d&#39;une seule et même cellule dans votre rapport.',
