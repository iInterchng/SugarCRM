...
class QuotesSugarpdfStandard extends QuotesSugarpdfQuotes{
    ...
    function preDisplay(){
       ...
       $html = $this->writeHTMLTable($quote, true, $this->headerOptions);
        $this->SetHeaderData(PDF_HEADER_LOGO, 160, $html);
...
// if ($this->bean->approvedstatus_c == 0){
	...
	//$cust=$this->bean->quote_stage;
      ...
      // $footer='<img border="0" src="file:///C:/Documents%20and%20Settings/Administrator.SALVE-B5CC8AF91/Desktop/567f1.jpg" width="1500" height="99">';
//$footer = html_entity_decode($footer);
//$this->MultiCell(0,0,$footer, 0, 'C',0,0,0,262,true,0,true);
       $this->AddPage();
       $this->footer_margin = 0;
...
//';
//$footer = html_entity_decode($footer);
//$this->MultiCell(0,0,$footer, 0, 'C',0,0,0,260,true,0,true);
	...
	<b>COMMERCIAL TERMS:</b></span></td> </tr>
    <tr>
		<td width="1570" align="left" colspan="3">&nbsp;</td> </tr>
    <tr><td width="350" align="left">
		<span style="font-size: large;">
		Prices</span></td> <td width="50" align="center">
		<span  style="font-size: large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span  style="font-size: large;">&nbsp;Ex-works Mumbai - Unpacked <br />
		</span></td></tr><tr><td width="350" align="left">
		<span  style="font-size: large;">
		Delivery</span></td> <td width="50" align="center">
		<span  style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span  style="font-size: large;">&nbsp;2 - 3 Weeks after receipt of techno-commercial clear purchase order.<br />
		</span></td></tr><tr><td width="350" align="left">
		<span style="font-size: large;">
		Payment</span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;"> &nbsp;40% advance along with the P.O. & balance against proforma invoice prior to dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">
		<span style="font-size: large;">
		Excise Duty</span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;"> &nbsp;Extra @12.36 % OR as applicable at the time of dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: large;">
		Sales Tax  </span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;">&nbsp;VAT Extra @12.50% OR as applicable at the time of dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: large;">
		Freight &amp; Octroi  </span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;">&nbsp;Extra at actuals. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: large;">
		Commissioning  </span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;">&nbsp;Extra Rs. 3000/- per day per engineer +12.36% Service Tax if applicable. <br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;">&nbsp;30 days<br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;"> &nbsp;15 months from the date of dispatch OR 12 months from the date of installation whichever is earlier<br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;"> &nbsp;At our works Mumbai.<br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: large;">&nbsp;Jurisdiction</span></td> <td width="50" align="center">
		<span style="font-size: large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: large;">&nbsp;Subject to Mumbai jurisdiction.<br />
		</span></td></tr><tr>

		<td width="1570" align="left" colspan="3">&nbsp;</td> </tr><tr>
		<td width="1570" align="left" colspan="3">&nbsp;</td> </tr><tr>
		<td width="1570" align="left" colspan="3"><b>
		<span style="font-size: large;">For UNITY
		CONTROLS PVT. LTD.</span></b></td> </tr><tr>
...
//$this->MultiCell(0,0, $html,1,'L',0,1,"","",true,0,true);
$this->writeHTML($html, true, 0, false, false, '');
//$this->SetXY(15, -28);
