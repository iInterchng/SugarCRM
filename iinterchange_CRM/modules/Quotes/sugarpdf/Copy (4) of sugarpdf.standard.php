...
$this->MultiCell(0,0,$footer, 0, 'C',0,0,0,260,true,0,true);
    ...
    <tr><td width="350" align="left">
		...
		<span  style="font-size: x-large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span  style="font-size: x-large;">&nbsp;Ex-works Mumbai - Unpacked <br />
		</span></td></tr><tr><td width="350" align="left">
		<span  style="font-size: x-large;">
		Delivery</span></td> <td width="50" align="center">
		<span  style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span  style="font-size: x-large;">&nbsp;2 - 3 Weeks after receipt of techno-commercial clear purchase order.<br />
		</span></td></tr><tr><td width="350" align="left">
		<span style="font-size: x-large;">
		Payment</span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;"> &nbsp;40% advance along with the P.O. & balance against proforma invoice prior to dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">
		<span style="font-size: x-large;">
		Excise Duty</span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;"> &nbsp;Extra @12.36 % OR as applicable at the time of dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: x-large;">
		Sales Tax  </span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;">&nbsp;VAT Extra @12.50% OR as applicable at the time of dispatch. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: x-large;">
		Freight &amp; Octroi  </span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;">&nbsp;Extra at actuals. <br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: x-large;">
		Commissioning  </span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;">&nbsp;Extra Rs. 3000/- per day per engineer +12.36% Service Tax if applicable. <br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: x-large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;">&nbsp;30 days<br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;"> &nbsp;15 months from the date of dispatch OR 12 months from the date of installation whichever is earlier<br />
		</span></td></tr><tr><td width="350" align="left">
		...
		<span style="font-size: x-large;"><strong>:</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;"> &nbsp;At our works Mumbai.<br />
		</span></td></tr><tr><td width="350" align="left">

        <span style="font-size: x-large;">&nbsp;Jurisdiction</span></td> <td width="50" align="center">
		<span style="font-size: x-large;"><strong> :</strong></span></td> <td width="1170" align="left">
		<span style="font-size: x-large;">&nbsp;Subject to Mumbai jurisdiction.<br />
		</span></td></tr><tr>

		<td width="1570" align="left" colspan="3">&nbsp;</td> </tr><tr>
		<td width="1570" align="left" colspan="3">&nbsp;</td> </tr><tr>
		<td width="1570" align="left" colspan="3"><b>
		<span style="font-size: x-large;">For UNITY
