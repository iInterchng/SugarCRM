...
$mod_strings = array (
  ...
  'LBL_WIZARD_PERSONALINFO' => 'Информация за Вас',
  ...
  'LBL_WIZARD_FINISH' => 'Натиснете <b>Край</b> за да запазите въведените настройки и да започнете да използвате Sugar.<br /><br /><br /><b>За повече информация относно Sugar:</b><br /><br /><br />&bull;&nbsp;Посетете страницата <a href="http://www.sugarcrm.com/university/" target="_blank">Материали за обучение</a>, която съдържа насоки за използване на програмата и видео материали<br /><br />&bull;&nbsp;Запознайте се с <a href="http://www.sugarcrm.com/crm/support/documentation" target="_blank">Документация на SugarCRM</a><br /><br />&bull;&nbsp;Отговори на въпроси и решения можете да намерите в <a href="http://kb.sugarcrm.com/" target="_blank">Knowledge Base</a><br />',
);
