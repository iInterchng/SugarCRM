...
$mod_strings = array (
  ...
  'ERR_UW_UPLOAD_ERR' => 'Ошибка загрузки файла, Пожалуйста, попробуйте еще раз!
\\n',
  ...
  'LBL_UW_CANCEL_DESC' => 'Мастер обновления был остановлен. Все временные файлы и архивы были удалены.

Нажмите кнопку "Готово" для повторного запуска мастера.',
  ...
  'LBL_UW_END_LOGOUT' => 'Обновление завершено.

Пожалуйста, выйдите и войдите в систему заново, если вы планируете в данный момент продолжить обновление используя Мастер обновления.',
...
Следующие файлы содержат новые поля или страницы, отредактированные в Студии. Обновление, которое Вы устанавливаете, содержит другие версии файлов. Для <u>каждого файла</u> Вы можете:<br><ul><li>[<b>Default</b>] Сохранить Вашу версию файла, оставив опцию неотмеченной. Файлы из пакета обновления будут пропущены.</li>or<li>Установить обновленные версии файлов, отметив соответствующую опцию. Ваши макеты будет необходимо заново воссоздать в Студии.</li></ul>',
  ...
  'LBL_LAYOUT_MERGE_DESC' => 'Доступны новые поля, которые были добавлены во время обновления и могут быть автоматически применены к существующему внешнему виду ваших модулей. Больше о новых полях можно узнать в Release Notes версии, до которой Вы обновляете систему.

Если Вы не хотите добавлять новые поля, уберите отметку с модуля и Ваши пользовательские настройки останутся без изменений. Поля будут доступны в Студии после завершения обновления.',
