...
$mod_strings = array (
  ...
  'SOCK_GREETING' => 'Questa è l´interfaccia per il Servizio di Schedulazione di SugarCRM. [ Comandi del servizio disponibili: start|restart|shutdown|status ]. Per uscire scrivi \'Esci\'. Per arrestare il servizio scrivi \'Chiudi\'.',
  ...
  'LBL_CRON_WINDOWS_DESC' => 'Nota: Per eseguire gli schedulatori di Sugat, creare un file batch usando le operazioni schedulate di Windows. Il file batch dovrebbe includere i seguenti comandi:',
  'LBL_NO_PHP_CLI' => 'Se il tuo server non ha disponibile il PHP, puoi usare wget o curl per lanciare le operazioni.<br /><br>per wget: <b>*    *    *    *    *    wget --quiet --non-verbose http://translate.sugarcrm.com/latest/cron.php > /dev/null 2>&1</b><br /><br>per curl: <b>*    *    *    *    *    curl --silent http://translate.sugarcrm.com/latest/cron.php > /dev/null 2>&1</b>',
