...
$mod_strings = array (
  ...
  'SOCK_GREETING' => '
Dette er grensesnittet for SugarCRM Planleggingsservice. [Tilgjenglige daemon-kommandoer: start|restart|shutdown|status] For å avslutte, tast \'quit\'. For å lukke tjenesten tast \'shutdown\'.',
