...
$mod_strings = array (
  ...
  'LBL_EAPM_SETTINGS' => 'Външни организации',
  ...
  'ERROR_VALIDATION_EXPIRED' => 'Грешка: Your validation key expired',
  ...
  'FATAL_LICENSE_ALTERED' => 'Your license has been altered since the last time you validated it. <br> Моля, посетете раздел <a href=\'index.php?action=LicenseSettings&module=Administration\'>\'"Лицензи"</a>  от секция Администриране.',
  ...
  'LBL_CHANGE_NAME_TABS' => 'Редактиране на етикети на табулатори',
  ...
  'LBL_HIDDEN_PANELS' => 'Скрити субпанели',
  ...
  'LBL_LOCALE_DEFAULT_CURRENCY_ISO4217' => 'Валутен символ ISO 4217',
  ...
  'LBL_LOCALE_DEFAULT_DECIMAL_SEP' => 'Знак за разделяне на десетичните числа',
  'LBL_LOCALE_DEFAULT_LANGUAGE' => 'Език по подразбиране',
  'LBL_LOCALE_DEFAULT_NAME_FORMAT' => 'Формат на името по подразбиране',
  'LBL_LOCALE_DEFAULT_NUMBER_GROUPING_SEP' => 'Разделител за хилядите',
  'LBL_LOCALE_DEFAULT_SYSTEM_SETTINGS' => 'Потребителски интерфейс',
  'LBL_LOCALE_DEFAULT_TIME_FORMAT' => 'Формат на часа по подразбиране',
  'LBL_LOCALE_EXAMPLE_NAME_FORMAT' => 'Пример',
  'LBL_LOCALE' => 'Дефиниране на регионалните настройки по подразбиране за системата.',
  ...
  'LBL_MANAGE_USERS' => 'Управление на профилите на потребителите в програмата',
  ...
  'LBL_UPGRADE_WIZARD' => 'Инсталиране на актуализации на SugarCRM',
  ...
  'LBL_VISIBLE_PANELS' => 'Показвани субпанели',
  ...
  'WARN_NO_SMTP_SERVER_AVAILABLE_ERROR' => 'Грешка: За да изпратите уведомление, SMTP сървъра трябва да бъде конфигуриран от <a href=\'index.php?module=EmailMan&action=config\'>Настройките на електронната поща</a>.',
