...
$connector_strings = array (
  'LBL_ID' => 'ID',
  'LBL_LICENSING_INFO' => 'ZoomInfo© は500万以上の会社の4,500万人以上のビジネス・パーソンについての詳細情報をご提供します。詳しくはhttp://www.zoominfo.com/about（英語）でどうぞ。',
  'LBL_SEARCH_FIELDS_INFO' => 'API：姓・名とメールアドレスのフィールドはZoominfo© パーソンによってサポートされています。',
  'LBL_EMAIL' => 'メールアドレス',
  'LBL_FIRST_NAME' => '名',
  'LBL_LAST_NAME' => '姓',
  'LBL_JOB_TITLE' => '役職名',
  'LBL_IMAGE_URL' => 'イメージURL',
  'LBL_SUMMARY_URL' => 'サマリーURL',
  'LBL_COMPANY_NAME' => '会社名',
  'LBL_ZOOMPERSON_URL' => 'Zoominfoパーソン URL',
  'LBL_DIRECT_PHONE' => '直通番号',
  'LBL_COMPANY_PHONE' => '会社番号',
  'LBL_FAX' => 'ファックス番号',
  ...
  'LBL_CURRENT_JOB_COMPANY_CITY' => '現職の市群区町村',
  ...
  'LBL_AFFILIATION_COMPANY_WEBSITE' => '所属会社のウェブサイト',
  'person_search_url' => '人物検索クエリURL',
  'person_detail_url' => '人物詳細クエリURL',
  'partner_code' => 'パートナーAPIコード',
  'api_key' => 'APIキー',
  'ERROR_LBL_CONNECTION_PROBLEM' => 'エラー：Zoominfo - パーソン・コネクターのサーバーに接続することができません。',
);
