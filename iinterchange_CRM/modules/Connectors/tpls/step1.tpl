...
<input title="{$mod.LBL_MERGE}" accessKey="{$APP.LBL_NEXT_BUTTON_KEY}" class="button" type="submit" name="button" value="{$mod.LBL_MERGE}"> 
<input title="{$APP.LBL_CANCEL_BUTTON_LABEL}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="button" onclick="document.ConnectorStep1.action.value='DetailView'; document.ConnectorStep1.module.value='{$module}';" type="submit" name="button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"> 
