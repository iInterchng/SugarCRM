...
$mod_strings = array (
  ...
  'LBL_SYNC_TO_DETAILVIEW_HELP' => 'Sélectionner cette option pour synchroniser cette mise en page de la vue Edition avec la mise en page de la vue Détail correspondante. <br>Lors du clic sur le bouton Sauvegarde ou Sauvegarder et Déployer dans la vue Edition, la disposition des champs de la vue Détail serra automatiquement mise à jour avec celle-ci. <br>Il ne serra plus possible de modifier la mise en page des champs sur la vue Edition.',
  'LBL_SYNC_TO_DETAILVIEW_NOTICE' => 'Cette vue Détail est synchronisé avec la vue Edition correspondante.<br>La disposition des champs dans cette vue Détail reflète la disposition des champs dans la vue Edition.<br>Les changements effectuées sur la cette vue Détail ne seront pas sauvegardé. Effectuez le changement sur la vue Edition correspondante ou décocher la case "Syncrho avec la vue Détail" présente sur la vue Edition.',
  'LBL_COPY_FROM_EDITVIEW' => 'Copie depuis la vue Edition',
  'LBL_DROPDOWN_BLANK_WARNING' => 'Les valeurs sont obligatoires pour les deux parties : Clé et Libellé. Pour ajouter un élément vide, cliquer sur Ajouter sans entrée de valeur ni dans la Clé, ni dans le Libellé',
  ...
  'LBL_POPHELP_DEPENDENT'=>"Créer une formule pour déterminer si un champ est visible dans les mises en page.<br/>"
        . "Les champs dépendant fonctionne aussi en temps réel sur les vues pour es mobiles, <br/>"
        . "mais ne sont pas pris en compte dans les applications tierces, comme par exemple Sugar Mobile pour iPhone. <br/>"
        . "Cela n&#39;est pas pris en compte non plus dans le Portail SugarCRM.",
