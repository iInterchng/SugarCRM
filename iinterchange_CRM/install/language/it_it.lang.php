...
$mod_strings = array (
  ...
  'LBL_DBCONFIG_MSG1' => 'Si prega di fornire il nome del database. Questo sarà lo spazio predefinito della tabella che sarà assegnato al tuo utente.',
  ...
  'ERR_DB_MYSQL_VERSION1' => 'La versione MySQL usata (',
  'ERR_DB_MYSQL_VERSION2' => ') non è supportata da Sugar. E´ necessario installare una versione che sia compatibile con l´applicazione di Sugar. Per conoscere le versioni MySQL supportate si prega di consultare la matrice di compatibilità nelle Release Note.',
  ...
  'LBL_DBCONF_HOST_NAME_MSSQL' => 'Nome Host \ Nome Instanza',
  ...
  'LBL_MSSQL_FTS' => 'Ricerca Full Text',
  'LBL_MSSQL_FTS_INSTALLED' => 'Installato',
  'LBL_MSSQL_FTS_INSTALLED_ERR1' => 'La funzionalità della ricerca full text non è stata installata.',
  'LBL_MSSQL_FTS_INSTALLED_ERR2' => 'E´ ancora possibile installare ma non si potrà utilizzare la funzionalità di Ricerca Full Text a meno che non venga installato nuovamente SQL Server, attivando la funzionalità di Ricerca Full Text. Per procedere si prega di consultare la guida per l´installazione di Sql Server, oppure contattare l´Amministratore.',
  ...
  'LBL_SESSION_ERR_DESCRIPTION' =>"SugarCRM si basa su sessioni PHP per memorizzare dati importanti mentre si è connessi a questo web server. La tua installazione PHP non ha i dati di sessione configurati correttamente.
                                                                <br><br>Un errore di configurazione comune è che la direttiva <b>'session.save_path'</b> non punta ad una directory valida.  <br>
                                                                <br>Si prega di correggere la <a target=_new href='http://us2.php.net/manual/en/ref.session.php'>configurazione PHP</a> nel file php.ini che si trova qui sotto.",
