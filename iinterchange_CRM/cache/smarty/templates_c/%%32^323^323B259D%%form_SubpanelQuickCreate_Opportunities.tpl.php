<?php /* Smarty version 2.6.11, created on 2014-05-09 17:21:40
         compiled from cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 37, false),array('function', 'counter', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 42, false),array('function', 'sugar_translate', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 49, false),array('function', 'sugar_getimagepath', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 108, false),array('function', 'html_options', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 176, false),array('function', 'sugar_number_format', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 222, false),array('function', 'sugarvar_teamset', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 494, false),array('modifier', 'default', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 43, false),array('modifier', 'strip_semicolon', 'cache/modules/Opportunities/form_SubpanelQuickCreate_Opportunities.tpl', 50, false),)), $this); ?>
...
" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate('Opportunities_subpanel_cancel_button');return false;" type="submit" name="Opportunities_subpanel_cancel_button" id="Opportunities_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
"> 
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['account_name']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['account_name']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['account_name']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['opportunity_type']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['opportunity_type']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['opportunity_type']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['amount']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['amount']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['amount']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['date_closed']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['date_closed']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['date_closed']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['next_step']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['next_step']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['next_step']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['sales_stage']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['sales_stage']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['sales_stage']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['lead_source']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['probability']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['probability']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['probability']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Opportunities'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'form_SubpanelQuickCreate_Opportunities','displayType' => 'renderEditView'), $this);?>

<?php else:  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'form_SubpanelQuickCreate_Opportunities','displayType' => 'renderDetailView'), $this);?>
...
<script type="text/javascript">
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_OPPORTUNITY_NAME','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'team_id\', \'team_list\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'team_set_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SET_ID','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'team_count\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Opportunities','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'team_name\', \'teamset\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Opportunities','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Opportunities\', \'next_step\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NEXT_STEP','module' => 'Opportunities','for_js' => true), $this); echo '\' );
