<?php /* Smarty version 2.6.11, created on 2014-05-08 12:46:57
         compiled from modules/Emails/templates/advancedSearch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Emails/templates/advancedSearch.tpl', 59, false),array('function', 'sugar_translate', 'modules/Emails/templates/advancedSearch.tpl', 73, false),array('function', 'html_options', 'modules/Emails/templates/advancedSearch.tpl', 85, false),)), $this); ?>
...
" alt="<?php echo $this->_tpl_vars['app_strings']['LBL_ENTER_DATE']; ?>
" id="searchDateFrom_trigger" align="absmiddle">
		</td>
	</tr>
...
');" maxlength='10' size='11' value="" type="text">&nbsp;
			<img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'jscalendar.gif'), $this);?>
" alt="<?php echo $this->_tpl_vars['app_strings']['LBL_ENTER_DATE']; ?>
" id="searchDateTo_trigger" align="absmiddle">		
		</td>
	</tr>
...
" onclick='open_popup("Users", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"advancedSearchForm","field_to_name_array":{"id":"assigned_user_id","name":"assigned_user_name"}}'; ?>
, "single", true);'>
        </a>
        </td>
    </tr>
...
" align="absmiddle" border="0" alt="<?php echo $this->_tpl_vars['mod_strings']['LBL_EMAIL_SELECTOR']; ?>
" onclick="SUGAR.email2.composeLayout.callopenpopupForEmail2('_search',{'form_name':'advancedSearchForm'} );">
         </a>
        </td>
    </tr>
     <tr class="toggleClass yui-hidden">
