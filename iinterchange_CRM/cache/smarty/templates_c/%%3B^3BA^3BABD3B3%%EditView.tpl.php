...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Relate/EditView.tpl', 30, false),)), $this); ?>
{*
/*********************************************************************************
...
>
<input type="hidden" name="<?php if (! empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo $this->_tpl_vars['idname']; ?>
_<?php endif;  echo smarty_function_sugarvar(array('key' => 'id_name'), $this);?>
" 
	id="<?php if (! empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo $this->_tpl_vars['idname']; ?>
_<?php endif;  echo smarty_function_sugarvar(array('key' => 'id_name'), $this);?>
" 
...
" tabindex="<?php echo $this->_tpl_vars['tabindex']; ?>
" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" class="button lastChild" 
onclick="this.form.<?php echo $this->_tpl_vars['idname']; ?>
.value = ''; this.form.<?php if (! empty ( $this->_tpl_vars['displayParams']['idName'] )):  echo $this->_tpl_vars['displayParams']['idName']; ?>
_<?php endif;  echo smarty_function_sugarvar(array('key' => 'id_name'), $this);?>
.value = '';" 
value="{$APP.LBL_CLEAR_BUTTON_LABEL}" <?php if (isset ( $this->_tpl_vars['displayParams']['javascript']['btn_clear'] )):  echo $this->_tpl_vars['displayParams']['javascript']['btn_clear'];  endif; ?>><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
<?php endif; ?>
</span>
