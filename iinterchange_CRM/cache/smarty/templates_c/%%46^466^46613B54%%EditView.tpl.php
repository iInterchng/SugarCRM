<?php /* Smarty version 2.6.11, created on 2014-05-08 12:50:56
         compiled from modules/Studio/DropDowns/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/Studio/DropDowns/EditView.tpl', 83, false),array('function', 'counter', 'modules/Studio/DropDowns/EditView.tpl', 108, false),array('modifier', 'default', 'modules/Studio/DropDowns/EditView.tpl', 131, false),)), $this); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td>
<h2 style='margin-bottom:10px;'><?php echo $this->_tpl_vars['title']; ?>
</h2>
<p><?php echo $this->_tpl_vars['MOD']['LBL_RENAME_TAB_WELCOME']; ?>
</p><br/>
<table cellspacing="2">
<tr>
<td valign="center">
    <input type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_UNDO']; ?>
" onclick="jstransaction.undo()" name="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_UNDO']; ?>
" />
</td>
<td valign="center">
    <input type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_REDO']; ?>
" onclick="jstransaction.redo()" name="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_REDO']; ?>
" />
</td>
<td valign="center">
    <input type="button" value="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_SAVE']; ?>
" 
        onclick='<?php echo 'if(check_form("editdropdown")){document.editdropdown.submit();}'; ?>
' 
        name="<?php echo $this->_tpl_vars['MOD']['LBL_BTN_SAVE']; ?>
" />
</td>
</tr>
</table>
...
<?php else: ?>
<table><tr><td>
<?php echo $this->_tpl_vars['MOD']['LBL_DROPDOWN_NAME']; ?>

</td><td><?php echo $this->_tpl_vars['MOD']['COLUMN_TITLE_NAME']; ?>
<input type='text' name='dropdown_name' value='<?php echo $this->_tpl_vars['dropdown_name']; ?>
'>
</td></tr><tr><td>
<?php echo $this->_tpl_vars['MOD']['LBL_DROPDOWN_LANGUAGE']; ?>
</td><td><?php echo smarty_function_html_options(array('name' => 'dropdown_lang','options' => $this->_tpl_vars['dropdown_languages'],'selected' => $this->_tpl_vars['dropdown_lang']), $this);?>
...
<span id='slot<?php echo $this->_tpl_vars['rowCounter']; ?>
b' >
<?php if (empty ( $this->_tpl_vars['disable_remove'] )): ?>
...
<?php if (empty ( $this->_tpl_vars['disable_add'] )): ?>
...
<script src = "include/javascript/yui/dragdrop.js" ></script>
			...
			function addDropDown(){
		      ...
		      if(/[\\\']/.test(keyValue)) {
		         alert("';  echo $this->_tpl_vars['MOD']['ERROR_INVALID_KEY_VALUE'];  echo '");
		         return false;
		      }
...
<?php endif; ?>
<input type='hidden' name='use_push' value='<?php echo $this->_tpl_vars['use_push']; ?>
'>
</form>
</td></tr>
</table>

<?php if (! empty ( $this->_tpl_vars['newDropDown'] )):  echo '
<script type="text/javascript">
addToValidate(\'editdropdown\', \'dropdown_name\', \'DBName\', true, \'';  echo $this->_tpl_vars['MOD']['LBL_DROPDOWN_NAME'];  echo ' [a-zA-Z_0-9]\' );
</script>
'; ?>
