<?php /* Smarty version 2.6.11, created on 2014-05-08 13:03:24
         compiled from modules/DynamicFields/templates/Fields/Forms/enum.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/DynamicFields/templates/Fields/Forms/enum.tpl', 41, false),array('function', 'html_options', 'modules/DynamicFields/templates/Fields/Forms/enum.tpl', 44, false),)), $this); ?>
...
app_list_strings = <?php echo $this->_tpl_vars['app_list_strings']; ?>
;
</script>
...
<br><input type='button' value='<?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'LBL_BTN_EDIT'), $this);?>
...
' class='button' onclick="ModuleBuilder.moduleDropDown('', this.form.name.value);">
	<?php else: ?>
