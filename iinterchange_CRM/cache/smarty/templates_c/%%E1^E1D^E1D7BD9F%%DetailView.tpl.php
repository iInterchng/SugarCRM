<?php /* Smarty version 2.6.11, created on 2014-05-09 16:23:47
         compiled from cache/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/DetailView.tpl', 91, false),array('modifier', 'trim', 'cache/modules/Leads/DetailView.tpl', 138, false),array('modifier', 'substr', 'cache/modules/Leads/DetailView.tpl', 526, false),array('modifier', 'to_url', 'cache/modules/Leads/DetailView.tpl', 528, false),array('modifier', 'escape', 'cache/modules/Leads/DetailView.tpl', 562, false),array('modifier', 'url2html', 'cache/modules/Leads/DetailView.tpl', 562, false),array('modifier', 'nl2br', 'cache/modules/Leads/DetailView.tpl', 562, false),array('modifier', 'strip_tags', 'cache/modules/Leads/DetailView.tpl', 567, false),array('function', 'sugar_include', 'cache/modules/Leads/DetailView.tpl', 68, false),array('function', 'sugar_translate', 'cache/modules/Leads/DetailView.tpl', 74, false),array('function', 'counter', 'cache/modules/Leads/DetailView.tpl', 80, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/DetailView.tpl', 113, false),array('function', 'sugar_getjspath', 'cache/modules/Leads/DetailView.tpl', 117, false),array('function', 'sugar_phone', 'cache/modules/Leads/DetailView.tpl', 266, false),array('function', 'sugarvar_teamset', 'cache/modules/Leads/DetailView.tpl', 994, false),)), $this); ?>
...
<ul class="yui-nav">
<li><a id="tab0" href="#tab0"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_INFORMATION','module' => 'Leads'), $this);?>
</em></a></li>
<li><a id="tab1" href="#tab1"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ADVANCED','module' => 'Leads'), $this);?>
</em></a></li>
<li><a id="tab2" href="#tab2"><em><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ASSIGNMENT','module' => 'Leads'), $this);?>
</em></a></li>
</ul>
...
<img id="dswidget_img" border="0" src="modules/Connectors/connectors/formatters/ext/rest/twitter/tpls/twitter.gif" alt="ext_rest_twitter" onmouseover="show_ext_rest_twitter(event);"><script type='text/javascript' src='<?php echo smarty_function_sugar_getjspath(array('file' => 'include/connectors/formatters/default/company_detail.js'), $this);?>
'></script>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['alt_address_street']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['lead_source_description']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['do_not_call']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
