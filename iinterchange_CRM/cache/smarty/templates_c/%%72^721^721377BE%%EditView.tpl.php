...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/SugarFields/Fields/File/EditView.tpl', 31, false),array('function', 'sugarvar', 'include/SugarFields/Fields/File/EditView.tpl', 34, false),array('modifier', 'default', 'include/SugarFields/Fields/File/EditView.tpl', 86, false),)), $this); ?>
{*
/*********************************************************************************
...
<?php endif; ?>
{if !$noChange}
<input type='button' class='button' value='{$APP.LBL_REMOVE}' onclick='SUGAR.field.file.deleteAttachment("<?php echo $this->_tpl_vars['idName']; ?>
...
" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" class="button lastChild" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"
onclick="SUGAR.field.file.clearRemote('<?php echo $this->_tpl_vars['idName']; ?>
'); return false;"
