<?php /* Smarty version 2.6.11, created on 2014-05-08 12:37:22
         compiled from modules/Trackers/tpls/TrackerSettings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Trackers/tpls/TrackerSettings.tpl', 55, false),)), $this); ?>
...
<input type="button" onclick="document.TrackerSettings.process.value='true'; if(check_form('TrackerSettings')) { document.TrackerSettings.submit(); }" class="button primary" title="<?php echo $this->_tpl_vars['app']['LBL_SAVE_BUTTON_TITLE']; ?>
...
<td scope="row" width="50%"><?php echo $this->_tpl_vars['mod']['LBL_ENABLE']; ?>
</td>
</tr>
...
?>
<tr>
<td scope="row" width="50%"><?php echo $this->_tpl_vars['entry']['label']; ?>
:&nbsp;<?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['entry']['helpLabel']), $this);?>
</td>
<td  width="50%"><input type="checkbox" id="<?php echo $this->_tpl_vars['key']; ?>
...
<tr>
<td scope="row" width="20%"><?php echo $this->_tpl_vars['mod']['LBL_TRACKER_PRUNE_INTERVAL']; ?>
</td>
