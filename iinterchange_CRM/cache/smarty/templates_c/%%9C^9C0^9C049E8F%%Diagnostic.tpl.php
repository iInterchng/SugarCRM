<?php /* Smarty version 2.6.11, created on 2014-05-08 12:15:41
...
<tr>
    <?php if ($this->_tpl_vars['NO_MYSQL_MESSAGE']): ?>
    <td><?php echo $this->_tpl_vars['NO_MYSQL_MESSAGE']; ?>
</td>
    <?php endif; ?>
	...
	<td scope="row"><slot><?php echo $this->_tpl_vars['MOD']['LBL_DIAGNOSTIC_MYSQLDUMPS']; ?>
</slot></td>
	<td ><slot><input name='mysql_dumps' class="checkbox" type="checkbox" tabindex='4' <?php echo $this->_tpl_vars['MYSQL_CAPABLE']; ?>
></slot></td>
	</tr><tr>
	<td scope="row"><slot><?php echo $this->_tpl_vars['MOD']['LBL_DIAGNOSTIC_MYSQLSCHEMA']; ?>
</slot></td>

	<td ><slot><input name='mysql_schema' class="checkbox" type="checkbox" tabindex='5' <?php echo $this->_tpl_vars['MYSQL_CAPABLE']; ?>
></slot></td>
	</tr><tr>
	<td scope="row"><slot><?php echo $this->_tpl_vars['MOD']['LBL_DIAGNOSTIC_MYSQLINFO']; ?>
</slot></td>
	<td ><slot><input name='mysql_info' class="checkbox" type="checkbox" tabindex='6' <?php echo $this->_tpl_vars['MYSQL_CAPABLE']; ?>
></slot></td>
	</tr><tr>
...
<?php echo $this->_tpl_vars['MYSQL_CAPABLE_CHECKBOXES']; ?>
