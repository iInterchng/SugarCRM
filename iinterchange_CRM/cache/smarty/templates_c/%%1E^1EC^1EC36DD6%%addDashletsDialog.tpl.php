<?php /* Smarty version 2.6.11, created on 2014-05-09 17:13:43
         compiled from include/MySugar/tpls/addDashletsDialog.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'include/MySugar/tpls/addDashletsDialog.tpl', 33, false),array('function', 'counter', 'include/MySugar/tpls/addDashletsDialog.tpl', 61, false),array('function', 'sugar_getimagepath', 'include/MySugar/tpls/addDashletsDialog.tpl', 78, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['chart']['title']; ?>
	...
	<?php endif; ?>
	<h3><span id="reportChartDashletsExpCol"><a href="javascript:void(0)" onClick="javascript:SUGAR.mySugar.collapseList('reportChartDashlets');"><img border="0" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'basic_search.gif'), $this);?>
" align="absmiddle" /></span></a>&nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_REPORT_CHARTS','module' => 'Home'), $this);?>
</h3>
	<div id="reportChartDashletsList">
		<div id="myFavoriteReportsChartDashlets" style="display:inline;">
			<h4><span id="myFavoriteExpCol"><a href="javascript:void(0)" onClick="javascript:SUGAR.mySugar.collapseReportList('myFavorite');"><img border="0" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'ProjectMinus.gif'), $this);?>
" align="absmiddle" /></a></span>&nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MY_FAVORITE_REPORT_CHARTS','module' => 'Home'), $this);?>
</h4>
			<div id="myFavoriteReportsChartDashletsList"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'img_loading.gif'), $this);?>
" align="absmiddle" /></div>
		</div>
		<div id="mySavedReportsChartDashlets" style="display:inline;">
			<h4><span id="mySavedExpCol"><a href="javascript:void(0)" onClick="javascript:SUGAR.mySugar.expandReportList('mySaved');"><img border="0" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'ProjectPlus.gif'), $this);?>
" align="absmiddle" /></a></span>&nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MY_SAVED_REPORT_CHARTS','module' => 'Home'), $this);?>
</h4>
			<div id="mySavedReportsChartDashletsList" style="display:none;"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'img_loading.gif'), $this);?>
" align="absmiddle" /></div>
		</div>
		<div id="myTeamReportsChartDashlets" style="display:inline;">
			<h4><span id="myTeamExpCol"><a href="javascript:void(0)" onClick="javascript:SUGAR.mySugar.expandReportList('myTeam');"><img border="0" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'ProjectPlus.gif'), $this);?>
" align="absmiddle" /></a></span>&nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MY_TEAM_REPORT_CHARTS','module' => 'Home'), $this);?>
</h4>
			<div id="myTeamReportsChartDashletsList" style="display:none;"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'img_loading.gif'), $this);?>
" align="absmiddle" /></div>
		</div>
		<div id="globalReportsChartDashlets" style="display:inline;">
			<h4><span id="globalExpCol"><a href="javascript:void(0)" onClick="javascript:SUGAR.mySugar.expandReportList('global');"><img border="0" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'ProjectPlus.gif'), $this);?>
" align="absmiddle" /></a></span>&nbsp;<?php echo smarty_function_sugar_translate(array('label' => 'LBL_GLOBAL_REPORT_CHARTS','module' => 'Home'), $this);?>
</h4>
			<div id="globalReportsChartDashletsList" style="display:none;"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'img_loading.gif'), $this);?>
" align="absmiddle" /></div>
		</div>
	</div>
</div>
