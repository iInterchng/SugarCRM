...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Reports/templates/_reportCriteriaWithResult.tpl', 39, false),)), $this); ?>
...
<input type="submit" class="button" name="runReportButton" id="runReportButton" accessKey="<?php echo $this->_tpl_vars['mod_strings']['LBL_RUN_REPORT_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['mod_strings']['LBL_RUN_REPORT_BUTTON_LABEL']; ?>
" title="<?php echo $this->_tpl_vars['mod_strings']['LBL_RUN_BUTTON_TITLE']; ?>
" 
	onclick="this.form.to_pdf.value='';this.form.to_csv.value='';this.form.save_report.value='';">

<?php if (( $this->_tpl_vars['report_edit_access'] )): ?>
<input type="submit" class="button" name="editReportButton" id="editReportButton" accessKey="<?php echo $this->_tpl_vars['app_strings']['LBL_EDIT_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['app_strings']['LBL_EDIT_BUTTON_LABEL']; ?>
" title="<?php echo $this->_tpl_vars['app_strings']['LBL_EDIT_BUTTON_TITLE']; ?>
" 
	onclick="this.form.to_pdf.value='';this.form.to_csv.value='';this.form.action.value='ReportsWizard';">
<?php endif; ?>    
<?php echo $this->_tpl_vars['duplicateButtons']; ?>

<?php if (( $this->_tpl_vars['report_edit_access'] )): ?>
<input type="button" class="button"  name="scheduleReportButton" id="scheduleReportButton" value="<?php echo $this->_tpl_vars['mod_strings']['LBL_REPORT_SCHEDULE_TITLE']; ?>
" 
	onclick="schedulePOPUP()">
<?php endif;  if (( $this->_tpl_vars['report_export_access'] )): ?>	
<input type="submit" class="button" name="printPDFButton" id="printPDFButton" accessKey="<?php echo $this->_tpl_vars['app_strings']['LBL_VIEW_PDF_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['app_strings']['LBL_VIEW_PDF_BUTTON_LABEL']; ?>
" title="<?php echo $this->_tpl_vars['app_strings']['LBL_VIEW_PDF_BUTTON_TITLE']; ?>
" 
	 onclick="this.form.save_report.value='';this.form.to_csv.value='';this.form.to_pdf.value='on'">
    
<?php endif;  if (( $this->_tpl_vars['report_export_as_csv_access'] )): ?>
<input type="button" class="button"  name="exportReportButton" id="exportReportButton" value="<?php echo $this->_tpl_vars['mod_strings']['LBL_EXPORT']; ?>
" onclick="do_export();">
<?php endif; ?>

<?php if (( $this->_tpl_vars['report_edit_access'] )): ?>
<input type="button" class="button"  name="deleteReportButton" id="deleteReportButton" accessKey="<?php echo $this->_tpl_vars['app_strings']['LBL_DELETE_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['app_strings']['LBL_DELETE_BUTTON_LABEL']; ?>
" title="<?php echo $this->_tpl_vars['app_strings']['LBL_DELETE_BUTTON_TITLE']; ?>
" 
	onclick="if (confirm(SUGAR.language.get('app_strings','NTC_DELETE_CONFIRMATION')))<?php echo '{'; ?>
this.form.to_pdf.value='';this.form.to_csv.value='';this.form.is_delete.value='1';this.form.action.value='ReportsWizard';this.form.submit();<?php echo '}'; ?>
">	
<?php endif; ?>    
</td>
</tr>
...
:<span valign="bottom" onmouseout="return nd();" onmouseover="return overlib('<?php echo $this->_tpl_vars['mod_strings']['LBL_VIEWER_RUNTIME_HELP']; ?>
', FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass', CLOSEFONTCLASS, 'olCloseFontClass' );">&nbsp;<img src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'helpInline.gif'), $this);?>
"></span></h3>
</div>
...
<script>
var current_db_type = '<?php echo $this->_tpl_vars['reporter_db_dbType']; ?>
';
</script>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['cache_path']; ?>
modules/modules_def_<?php echo $this->_tpl_vars['current_language']; ?>
...
'&c=<?php echo $this->_tpl_vars['sugar_config']['js_custom_version']; ?>
"></script>
<script language="javascript">
...
<script type="text/javascript" src="include/javascript/reportCriteria.js?s='<?php echo $this->_tpl_vars['sugar_version']; ?>
'&c=<?php echo $this->_tpl_vars['sugar_config']['js_custom_version']; ?>
"></script>
<script language="javascript">
