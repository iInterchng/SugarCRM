...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Meetings/EditView.tpl', 43, false),array('function', 'counter', 'cache/modules/Meetings/EditView.tpl', 48, false),array('function', 'sugar_translate', 'cache/modules/Meetings/EditView.tpl', 52, false),array('function', 'html_options', 'cache/modules/Meetings/EditView.tpl', 107, false),array('function', 'sugar_getimagepath', 'cache/modules/Meetings/EditView.tpl', 228, false),array('function', 'sugarvar_teamset', 'cache/modules/Meetings/EditView.tpl', 562, false),array('modifier', 'default', 'cache/modules/Meetings/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/Meetings/EditView.tpl', 61, false),array('modifier', 'escape', 'cache/modules/Meetings/EditView.tpl', 474, false),array('modifier', 'url2html', 'cache/modules/Meetings/EditView.tpl', 474, false),array('modifier', 'nl2br', 'cache/modules/Meetings/EditView.tpl', 474, false),)), $this); ?>
...
" class="button primary" onclick="fill_invitees();document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value=''; <?php endif; ?> formSubmitCheck();"type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
">
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="window.location.href='index.php?action=index&module=Meetings'; return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
" class="button" onclick="document.EditView.send_invites.value='1';fill_invitees();document.EditView.action.value='Save';document.EditView.return_action.value='EditView';document.EditView.return_module.value='<?php echo $_REQUEST['return_module']; ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MEETING_INFORMATION','module' => 'Meetings'), $this);?>
</h4>
</th>
</tr>
...
&nbsp;<span class="dateFormat"><?php echo $this->_tpl_vars['MOD']['LBL_HOURS_MINS']; ?>
</span></div>
<?php else: ?>
<td></td><td></td>
</td>
...
<?php if ($this->_tpl_vars['fields']['reminder_checked']['value'] == '1'):  $this->assign('REMINDER_TIME_DISPLAY', 'inline');  $this->assign('REMINDER_CHECKED', 'checked');  else:  $this->assign('REMINDER_TIME_DISPLAY', 'none');  $this->assign('REMINDER_CHECKED', "");  endif; ?><input tabindex="108"  name="reminder_checked" type="hidden" value="0"><input tabindex="108"  name="reminder_checked" onclick='toggleDisplay("should_remind_list");' type="checkbox" class="checkbox" value="1" <?php echo $this->_tpl_vars['REMINDER_CHECKED']; ?>
...
<tr>
<th align="left" colspan="8">
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_ASSIGNMENT','module' => 'Meetings'), $this);?>
</h4>
</th>
</tr>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
function formSubmitCheck(){if(check_form('EditView') && isValidDuration()){document.EditView.submit();}}</script>
...
&module_name=Meetings", true, false,  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } ); return false;' type="submit" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
"><?php endif;  endif; ?>
</div> <?php echo $this->_tpl_vars['overlibStuff']; ?>
...
<script type="text/javascript">
addToValidate(\'EditView\', \'id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'team_id\', \'team_list\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'team_set_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SET_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'team_count\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'team_name\', \'teamset\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'accept_status\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'set_accept_links\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'host_url\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_URL','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'displayed_url\', \'url\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_URL','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'parent_type\', \'parent_type\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'EditView\', \'reminder_time\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER_TIME','module' => 'Meetings','for_js' => true), $this); echo '\' );
