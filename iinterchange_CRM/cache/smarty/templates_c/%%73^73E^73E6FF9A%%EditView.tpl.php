...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Users/EditView.tpl', 35, false),array('function', 'sugar_image', 'modules/Users/EditView.tpl', 108, false),array('function', 'sugar_help', 'modules/Users/EditView.tpl', 164, false),array('function', 'sugar_password_requirements_box', 'modules/Users/EditView.tpl', 420, false),array('function', 'sugar_getimagepath', 'modules/Users/EditView.tpl', 449, false),array('function', 'html_options', 'modules/Users/EditView.tpl', 557, false),)), $this); ?>
<!--
/*********************************************************************************
...
:</slot></td>
                            ...
                            <?php if (! $this->_tpl_vars['IS_GROUP'] && ! $this->_tpl_vars['IS_PORTALONLY']): ?>
                            <tr>
                               <td width="17%" scope="row">
                               <?php echo $this->_tpl_vars['APP']['LBL_PICTURE_FILE']; ?>
:
                               </td>
                               <td width="33%">
                               <?php echo $this->_tpl_vars['PICTURE_FILE_CODE']; ?>
...
'>
                    ...
                    <td width='60%' style="vertical-align:middle;">
                        <?php if (! $this->_tpl_vars['IS_PORTALONLY']): ?>
                            <?php echo smarty_function_sugar_password_requirements_box(array('width' => '300px','class' => 'x-sqs-list','style' => 'background-color:white; padding:5px !important;'), $this);?>
...
:</slot>&nbsp;<?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_OWN_OPPS_DESC']), $this);?>
</td>
                            <td ><slot><input tabindex='12' type="checkbox" name="no_opps" <?php echo $this->_tpl_vars['NO_OPPS']; ?>
></slot></td>
                        </tr>
...
">
        <?php if ($this->_tpl_vars['PDF_CLASS'] == 'TCPDF'): ?>
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
                        <tr>
