<?php /* Smarty version 2.6.11, created on 2014-05-08 12:28:38
...
<input type="button" onclick="document.AdminSettings.process.value='true'; if(check_form('AdminSettings')) { document.AdminSettings.submit(); }" class="button primary" title="<?php echo $this->_tpl_vars['app']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['app']['LBL_SAVE_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['app']['LBL_SAVE_BUTTON_LABEL']; ?>
">
<input type="button" onclick="document.AdminSettings.process.value='false'; document.AdminSettings.submit();" class="button" title="<?php echo $this->_tpl_vars['app']['LBL_CANCEL_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['app']['LBL_CANCEL_BUTTON_KEY']; ?>
" value="<?php echo $this->_tpl_vars['app']['LBL_CANCEL_BUTTON_LABEL']; ?>
">
<input type="button" onclick="document.AdminSettings.process.value='deleteRecords'; if(confirm('<?php echo $this->_tpl_vars['mod']['LBL_CONFIRM_DELETE_RECORDS']; ?>
...
<?php echo $this->_tpl_vars['mod']['LBL_ENABLE_EXTERNAL_CONNECTORS']; ?>
