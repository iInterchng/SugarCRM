<?php /* Smarty version 2.6.11, created on 2014-05-09 16:32:55
         compiled from cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 38, false),array('function', 'counter', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 43, false),array('function', 'sugar_translate', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 50, false),array('function', 'html_options', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 97, false),array('function', 'sugar_getimagepath', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 218, false),array('function', 'sugarvar_teamset', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 501, false),array('modifier', 'default', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 44, false),array('modifier', 'strip_semicolon', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 51, false),array('modifier', 'escape', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 541, false),array('modifier', 'url2html', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 541, false),array('modifier', 'nl2br', 'cache/modules/Meetings/form_SubpanelQuickCreate_Meetings.tpl', 541, false),)), $this); ?>
...
" class="button" onclick="return SUGAR.subpanelUtils.cancelCreate('Meetings_subpanel_cancel_button');return false;" type="submit" name="Meetings_subpanel_cancel_button" id="Meetings_subpanel_cancel_button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
"> 
<input title="<?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_KEY']; ?>
" class="button" onclick="disableOnUnloadEditView(this.form); this.form.return_action.value='DetailView'; this.form.action.value='EditView'; if(typeof(this.form.to_pdf)!='undefined') this.form.to_pdf.value='0';" type="submit" name="Meetings_subpanel_full_form_button" id="Meetings_subpanel_full_form_button" value="<?php echo $this->_tpl_vars['APP']['LBL_FULL_FORM_BUTTON_LABEL']; ?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['type']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['type']['acl'] > 0 )): ?>
<td valign="top" id='type_label' width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Meetings'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['type']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['password']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['password']['acl'] > 0 )): ?>
<td valign="top" id='password_label' width='12.5%' scope="row">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSWORD','module' => 'Meetings'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>

<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['password']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['password']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['password']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['password']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['password']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['password']['value']; ?>
</span>
</td>
<?php endif;  else: ?>
<td></td><td></td>
...
.update(); SugarWidgetScheduler.update_time();" onchange="combo_<?php echo $this->_tpl_vars['fields']['date_start']['name']; ?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['duration_hours']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['duration_hours']['acl'] > 0 )): ?>
...
<?php if ($this->_tpl_vars['fields']['duration_hours']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<div class="duration"><input tabindex="106"  name="duration_hours" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['reminder_time']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['reminder_time']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['reminder_time']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<?php endif;  else: ?>
<td></td><td></td>
<?php endif;  if ($this->_tpl_vars['fields']['location']['acl'] > 1 || ( $this->_tpl_vars['showDetailData'] && $this->_tpl_vars['fields']['location']['acl'] > 0 )): ?>
...
<td valign="top" width='37.5%' >
<?php if ($this->_tpl_vars['fields']['location']['acl'] > 1):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
" class="sqsEnabled" tabindex="109" id="<?php echo $this->_tpl_vars['fields']['assigned_user_name']['name']; ?>
...
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Meetings'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'form_SubpanelQuickCreate_Meetings','displayType' => 'renderEditView'), $this);?>

<?php else:  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php echo smarty_function_sugarvar_teamset(array('parentFieldArray' => 'fields','vardef' => $this->_tpl_vars['fields']['team_name'],'tabindex' => 1,'display' => '','labelSpan' => '','fieldSpan' => '','formName' => 'form_SubpanelQuickCreate_Meetings','displayType' => 'renderDetailView'), $this);?>
...
<script type="text/javascript">
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'team_id\', \'team_list\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'team_set_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAM_SET_ID','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'team_count\', \'relate\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'team_name\', \'teamset\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_TEAMS','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'accept_status\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'set_accept_links\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_SUBJECT','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'host_url\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_URL','module' => 'Meetings','for_js' => true), $this); echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'displayed_url\', \'url\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_URL','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'parent_type\', \'parent_type\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'parent_id\', \'id\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_LIST_RELATED_TO','module' => 'Meetings','for_js' => true), $this); echo '\' );
...
addToValidate(\'form_SubpanelQuickCreate_Meetings\', \'reminder_time\', \'int\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_REMINDER_TIME','module' => 'Meetings','for_js' => true), $this); echo '\' );
