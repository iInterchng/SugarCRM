<?php /* Smarty version 2.6.11, created on 2014-05-08 12:39:29
         compiled from modules/EmailMan/tpls/config.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/EmailMan/tpls/config.tpl', 35, false),)), $this); ?>
<!--
/*********************************************************************************
...
&imageName=helpInline.gif">
				 		    ...
				 		    <td width="30%">
							     ...
							     <input name='notify_allow_default_outbound' value="2" tabindex='1' class="checkbox" type="checkbox" <?php echo $this->_tpl_vars['notify_allow_default_outbound_on']; ?>
>
							</td>
							<td width="20%">&nbsp;</td>
							<td width="30%">&nbsp;</td>
...
:&nbsp;
        	<img border="0" onmouseout="return nd();" onmouseover="return overlib('<?php echo $this->_tpl_vars['MOD']['LBL_NOTIFICATION_ON_DESC']; ?>
', FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass', CLOSEFONTCLASS, 'olCloseFontClass', WIDTH, -1, NOFOLLOW, 'ol_nofollow')" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
    	</td>
...
:
    	   <img border="0" onmouseout="return nd();" onmouseover="return overlib('<?php echo $this->_tpl_vars['MOD']['LBL_FROM_ADDRESS_HELP']; ?>
', FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass', CLOSEFONTCLASS, 'olCloseFontClass')" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif">
    	</td>
