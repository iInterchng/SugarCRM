...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/Emails/templates/assignTo.tpl', 40, false),)), $this); ?>
...
" accesskey="<?php echo $this->_tpl_vars['app_strings']['LBL_SELECT_BUTTON_KEY']; ?>
...
" accesskey="<?php echo $this->_tpl_vars['app_strings']['LBL_CLEAR_BUTTON_KEY']; ?>
...
" type="button">
    ...
    <tr>
    	   <td scope="row" nowrap="nowrap" valign="top"><?php echo $this->_tpl_vars['app_strings']['LBL_TEAMS']; ?>
:&nbsp;</td>
    	   <td ><?php echo $this->_tpl_vars['TEAM_SET_FIELD_FOR_ASSIGNEDTO']; ?>
</td>
    	   <td>&nbsp;</td>
    </tr>
