<?php /* Smarty version 2.6.11, created on 2014-05-09 15:37:14
         compiled from modules/Configurator/tpls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Configurator/tpls/EditView.tpl', 34, false),array('function', 'sugar_help', 'modules/Configurator/tpls/EditView.tpl', 92, false),array('function', 'sugar_getimagepath', 'modules/Configurator/tpls/EditView.tpl', 359, false),)), $this); ?>
...
&nbsp<?php echo smarty_function_sugar_help(array('text' => $this->_tpl_vars['MOD']['LBL_PROXY_ON_DESC']), $this);?>
	...
	<?php endif; ?>
	<td width="75%" align="left"  valign='middle' colspan='3'><input type='hidden' name='proxy_on' value='0'><input name="proxy_on" value="1" class="checkbox" tabindex='1' type="checkbox" <?php echo $this->_tpl_vars['proxy_on_checked']; ?>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	<tr>
	<th align="left" scope="row" colspan="4"><h4><?php echo $this->_tpl_vars['MOD']['LBL_MAILMERGE']; ?>
</h4></th>
	</tr>
	<tr>
