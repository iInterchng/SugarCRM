...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getimagepath', 'modules/Emails/templates/editAccountDialogue.tpl', 92, false),)), $this); ?>
...
">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="edit view">
				<tr>
				    ...
				    <td style="vertical-align:bottom;"><a href="javascript:void(0);" onclick="javascript:SUGAR.email2.accounts.fillInboundGmailDefaults();"><?php echo $this->_tpl_vars['app_strings']['LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS']; ?>
</a>&nbsp;</td>
				</tr>
			    <tr>
