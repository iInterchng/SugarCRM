<?php /* Smarty version 2.6.11, created on 2014-05-09 17:22:09
         compiled from cache/modules/Opportunities/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Opportunities/DetailView.tpl', 29, false),array('function', 'counter', 'cache/modules/Opportunities/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Opportunities/DetailView.tpl', 44, false),array('function', 'sugar_number_format', 'cache/modules/Opportunities/DetailView.tpl', 111, false),array('function', 'sugarvar_teamset', 'cache/modules/Opportunities/DetailView.tpl', 431, false),array('modifier', 'strip_semicolon', 'cache/modules/Opportunities/DetailView.tpl', 45, false),array('modifier', 'escape', 'cache/modules/Opportunities/DetailView.tpl', 343, false),array('modifier', 'url2html', 'cache/modules/Opportunities/DetailView.tpl', 343, false),array('modifier', 'nl2br', 'cache/modules/Opportunities/DetailView.tpl', 343, false),)), $this); ?>
...
<?php endif;  if ($this->_tpl_vars['fields']['account_name']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['amount']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['date_closed']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['sales_stage']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['opportunity_type']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['probability']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['lead_source']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php ob_start(); ?>
<tr>
<?php if ($this->_tpl_vars['fields']['next_step']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php else: ?>
<td scope="row">&nbsp;</td><td>&nbsp;</td>
<?php endif;  if ($this->_tpl_vars['fields']['campaign_name']['acl'] > 0):  echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
