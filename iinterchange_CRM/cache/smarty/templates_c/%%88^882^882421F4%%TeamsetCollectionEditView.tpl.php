...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/SugarFields/Fields/Teamset/TeamsetCollectionEditView.tpl', 37, false),array('function', 'sugar_translate', 'include/SugarFields/Fields/Teamset/TeamsetCollectionEditView.tpl', 63, false),array('function', 'sugar_getimagepath', 'include/SugarFields/Fields/Teamset/TeamsetCollectionEditView.tpl', 63, false),)), $this); ?>

	        	
<?php ob_start();  echo $this->_tpl_vars['vardef']['name'];  $this->_smarty_vars['capture']['idname'] = ob_get_contents();  $this->assign('idname', ob_get_contents());ob_end_clean();  if (! empty ( $this->_tpl_vars['displayParams']['idName'] )): ?>
...
_<?php echo $this->_tpl_vars['idname']; ?>
"].js_more();' name="teamSelect"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
...
'].more_status)collection['<?php echo $this->_tpl_vars['displayParams']['formName']; ?>
_<?php echo $this->_tpl_vars['idname']; ?>
'].js_more();" name="teamAdd"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-add.png"), $this);?>
"></button>
			</span>
        </td>
        <td>
        ...
        <td align='center' id="lineLabel_<?php echo $this->_tpl_vars['idname']; ?>
...
_<?php echo $this->_tpl_vars['idname']; ?>
' <?php if (empty ( $this->_tpl_vars['values']['secondaries'] )): ?>style="display:none; text-decoration:none;"<?php else: ?>style="text-decoration:none;"<?php endif; ?>>
            <input id="arrow_<?php echo $this->_tpl_vars['idname']; ?>
" name="arrow_<?php echo $this->_tpl_vars['idname']; ?>
" type="hidden" value="show">
            <img id='more_img_<?php echo $this->_tpl_vars['displayParams']['formName']; ?>
_<?php echo $this->_tpl_vars['idname']; ?>
' height="8" border="0" width="8" absmiddle="" alt="Hide/Show" src="<?php echo smarty_function_sugar_getimagepath(array('file' => 'advanced_search.gif'), $this);?>
"/>
...
_collection_0" id="<?php echo $this->_tpl_vars['idname']; ?>
...
_collection_0" id="id_<?php echo $this->_tpl_vars['idname']; ?>
_collection_0" value="">
            </span>
        </td>
<!-- BEGIN Remove and Radio -->
        <td valign='top' align='left' nowrap>
            <img id="remove_<?php echo $this->_tpl_vars['idname']; ?>
_collection_0" name="remove_<?php echo $this->_tpl_vars['idname']; ?>
...
_<?php echo $this->_tpl_vars['idname']; ?>
'].remove(0);" class="id-ff-remove"/><?php if (! empty ( $this->_tpl_vars['displayParams']['allowNewValue'] )): ?><input type="hidden" name="allow_new_value_<?php echo $this->_tpl_vars['idname']; ?>
...
_collection" type="radio" class="radio" <?php if ($this->_tpl_vars['displayParams']['primaryChecked']): ?>checked="checked"<?php endif; ?> value="0" onclick="collection['<?php echo $this->_tpl_vars['displayParams']['formName']; ?>
_<?php echo $this->_tpl_vars['idname']; ?>
'].changePrimary(true);"/>
            </span>
        </td>
...
<script type="text/javascript">
 	document.getElementById("id_<?php echo $this->_tpl_vars['idname']; ?>
