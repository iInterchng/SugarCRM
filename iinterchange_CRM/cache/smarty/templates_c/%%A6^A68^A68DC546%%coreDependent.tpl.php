<?php /* Smarty version 2.6.11, created on 2014-05-08 12:55:53
         compiled from modules/DynamicFields/templates/Fields/Forms/coreDependent.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/DynamicFields/templates/Fields/Forms/coreDependent.tpl', 36, false),array('function', 'sugar_getimagepath', 'modules/DynamicFields/templates/Fields/Forms/coreDependent.tpl', 42, false),array('modifier', 'escape', 'modules/DynamicFields/templates/Fields/Forms/coreDependent.tpl', 84, false),)), $this); ?>
<?php if ($this->_tpl_vars['vardef']['type'] != 'enum' && $this->_tpl_vars['vardef']['type'] != 'address' && $this->_tpl_vars['vardef']['type'] != 'html' && $this->_tpl_vars['vardef']['type'] != 'multienum' && $this->_tpl_vars['vardef']['type'] != 'radioenum' && $this->_tpl_vars['vardef']['type'] != 'relate' && $this->_tpl_vars['vardef']['type'] != 'url' && $this->_tpl_vars['vardef']['type'] != 'iframe' && $this->_tpl_vars['vardef']['type'] != 'parent' && $this->_tpl_vars['vardef']['type'] != 'image'): ?>
...
">
        <?php endif; ?>
		<img id="calcToolTipIcon" src="<?php echo smarty_function_sugar_getimagepath(array('file' => "helpInline.gif"), $this);?>
" />
		<input type="hidden" name="enforced" id="enforced" value="<?php echo $this->_tpl_vars['vardef']['enforced']; ?>
">
		<script>
			if (!ModuleBuilder.cfToolTip)
			     ModuleBuilder.cfToolTip = new YAHOO.widget.Tooltip("cfToolTip", {
			...
			ModuleBuilder.toggleCF(<?php if (empty ( $this->_tpl_vars['vardef']['calculated'] ) || empty ( $this->_tpl_vars['vardef']['formula'] )): ?>false<?php else:  echo $this->_tpl_vars['vardef']['calculated'];  endif; ?>)
		</script>
    </td>
</tr>
...
<tr><td class='mbLBL'><?php echo smarty_function_sugar_translate(array('module' => 'DynamicFields','label' => 'LBL_DEPENDENT'), $this);?>
:</td>
    <td><input type="checkbox" name="dependent" id="dependent" value="1" onclick ="ModuleBuilder.toggleDF()"
        ...
        <img id="depToolTipIcon" src="<?php echo smarty_function_sugar_getimagepath(array('file' => "helpInline.gif"), $this);?>
" />
        <script>
			if (!ModuleBuilder.dfToolTip)
			     ModuleBuilder.dfToolTip = new YAHOO.widget.Tooltip("dfToolTip", {
