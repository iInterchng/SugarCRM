...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'include/EditView/EditView.tpl', 41, false),array('function', 'math', 'include/EditView/EditView.tpl', 95, false),array('function', 'sugar_field', 'include/EditView/EditView.tpl', 164, false),array('function', 'sugar_evalcolumn', 'include/EditView/EditView.tpl', 169, false),array('modifier', 'count', 'include/EditView/EditView.tpl', 86, false),)), $this); ?>
{*
/*********************************************************************************
...
?>
			        <?php if ($this->_tpl_vars['fields'][$this->_tpl_vars['subField']['name']]): ?>
			            ...
			            <?php echo smarty_function_sugar_field(array('parentFieldArray' => 'fields','tabindex' => $this->_tpl_vars['colData']['field']['tabindex'],'vardef' => $this->_tpl_vars['fields'][$this->_tpl_vars['subField']['name']],'displayType' => 'DetailView','displayParams' => $this->_tpl_vars['subField']['displayParams'],'formName' => $this->_tpl_vars['form_name']), $this);?>
&nbsp;
			        <?php endif; ?>
			    <?php endforeach; endif; unset($_from); ?>
			<?php elseif (! empty ( $this->_tpl_vars['colData']['field']['customCode'] )): ?>
