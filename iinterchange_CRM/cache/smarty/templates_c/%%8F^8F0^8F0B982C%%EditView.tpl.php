<?php /* Smarty version 2.6.11, created on 2014-05-08 12:16:58
         compiled from modules/Currencies/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_help', 'modules/Currencies/EditView.tpl', 45, false),)), $this); ?>
...
">
<img border="0" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
&imageName=helpInline.gif" onmouseover="return overlib('<?php echo $this->_tpl_vars['MOD']['LBL_LIST_RATE_HELP']; ?>
', FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass', CLOSEFONTCLASS, 'olCloseFontClass', WIDTH, -1, NOFOLLOW, 'ol_nofollow' );" onmouseout="return nd();"/>
</slot></td>
