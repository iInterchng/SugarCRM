...
',
  ...
  'FATAL_LICENSE_EXPIRED' => '',
  'FATAL_LICENSE_EXPIRED2' => '',
  'FATAL_LICENSE_REQUIRED' => '',
  'FATAL_VALIDATION_EXPIRED' => '',
  ...
  'LBL_MANUAL_VALIDATION' => '
	...
	If your system environment prohibits your system from communicating to the  validation server through the internet, you should proceed with the <a href="#" onclick="toggleDisplay(\'mainbody\');toggleDisplay(\'manualbody\');">Manual Validation</a> steps. ',
  'LBL_MANUAL_VALIDATION1' => 'Step 1: Generate a information file by clicking the following button. ',
  'LBL_MANUAL_VALIDATION2' => 'Then save the file (sugarkey.lic) on your local file system.',
  'LBL_MANUAL_VALIDATION3' => 'Step 2: Transfer the sugarkey.lic file to a system where you can access the internet with a web browser.   <br<br>Go to <a href="">  ',
...
',
  ...
  'WARN_LICENSE_SEATS' => 'Warning: User by ',
  ...
  'WARN_LICENSE_SEATS_MAXED' => 'Warning: The number of active users is already the maximum number of ',
  'WARN_LICENSE_SEATS_EDIT_USER' => 'Warning: The number of active users is already the maximum number of allowed',
  'WARN_LICENSE_SEATS_USER_CREATE' => 'Warning: The number of active users allowed by your matches the number of active users in the system. You will not be able to create additional active users.',
  ...
  'LBL_UPDATE_CHECK_LOCKOUT_NOTICE' => '',
