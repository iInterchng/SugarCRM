...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the application and cannot log in using his/her existing password.',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Mail Client:</b> Send emails using the email client in the  application.<br><b>External Mail Client:</b> Send email using an email client outside of the application, such as Microsoft Outlook.',
  ...
  'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email).  This type cannot login through the  web interface.',
  ...
  'LBL_PHONE' => 'Phone',
  'LBL_PICK_TZ_WELCOME' => 'Welcome CRM APPS.',
  ...
  'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the web interface.',
  ...
  'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the   Plug-in for Microsoft&reg; Outlook&reg; and the   Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using ',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using .',
  ...
  'LBL_WIZARD_FINISH_TITLE' => 'Click to Finish',
  'LBL_WIZARD_FINISH' => 'Click <b>Finish</b> below to save your settings and to begin using CRM. For more information on using CRM:<br /><br />
<table cellpadding=0 cellspacing=0>
<tr><td><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.ecrm.com/university" target="_blank"><b>CRM</b></a><br>End-user and System Administrator Training and Resources</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="http://docs.ecrm.com/" target="_blank"><b>Documentation</b></a><br>Product Guides and Release Notes</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/kb.png style="margin-right: 5px;"></td><td><a href="http://kb.crm.com/" target="_blank"><b>Knowledge Base</b></a><br>Tips from CRM Support for performing common tasks and processes in  in crm </td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.crm.com/forums" target="_blank"><b>Forums</b></a><br>Forums </td></tr>
</table>',
  'LBL_WIZARD_PERSONALINFO' => 'Your Information',
  'LBL_WIZARD_LOCALE' => 'Your Locale',
  'LBL_WIZARD_SMTP' => 'Your Email Account',
  'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible <br />Fields marked with <span class="required">*</span> are required.',
  'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies.',
