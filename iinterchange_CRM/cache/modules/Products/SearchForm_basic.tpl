...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			{sugar_translate label='LBL_NAME' module='Products'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		{sugar_translate label='LBL_FAVORITES_FILTER' module='Products'}
    	</td>
