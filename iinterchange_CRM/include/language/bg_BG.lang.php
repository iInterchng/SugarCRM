...
$app_strings = array (
  ...
  'LBL_EMAIL_SMTP_SSL_OR_TLS' => 'Дай възможност на SMTP през SSL или TLS',
  ...
  'LBL_EMAIL_POP3_REMOVE_MESSAGE' => 'Mail Server протокол от тип POP3 няма да бъде поддържан в следващата версия. Само IMAP ще бъде поддържан.',
  ...
  'LBL_EMAIL_COMPOSE_READ' => 'Прочети & напиши ново писмо',
  ...
  'LBL_EMAIL_FOLDERS_DELETE_CONFIRM' => 'Сигурни ли сте, че искате да изтриете тази папка?nПроцесът е необратим.nС изтриването на папката ще бъдат изтрити и всички включени към нея папки.',
  ...
  'ERR_SINGLE_QUOTE' => 'Символът \'кавичка\' не може да бъде използван за дадено поле.  Моля, въведете друга стойност.',
  ...
  'LBL_FAVORITES_FILTER' => 'Моите Снимки:',
  'LBL_HIDE' => 'Скрий',
  ...
  'LNK_PRINT' => 'Печат',
  'LNK_BACKTOTOP' => 'Начало на страница',
  'LNK_REMOVE' => 'изтрий',
  'LNK_RESUME' => 'Резюме',
  ...
  'LBL_NO_FLASH_PLAYER' => 'Ползвате стара версия на Adobe\'s Flash Player или Ви е изключена Flash-анимация. Моля, <a href="http://www.adobe.com/go/getflashplayer/">инсталирайте най-новата версия на Flash player</a> или активирайте flash.',
