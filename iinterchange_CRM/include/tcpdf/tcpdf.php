	...
	class TCPDF {
		...
		*/
		...
		public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
			...
			$this->SetAutoPageBreak(true, (0 * $margin));   //change by salve 2 to 0
		...
		public function setPageFormat($format, $orientation='P') {
			...
			if (is_string($format)) {
				...
				switch (strtoupper($format)) {
					...
					case 'LETTER': {$format = array(612.00,841.89); break;}
		...
		*/
		...
		//	$this->SetLineStyle(array('width' => $line_width, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)));
           ...
           // $footer='<img border="0" src="file:///C:/Documents%20and%20Settings/Administrator.SALVE-B5CC8AF91/Desktop/567f1.jpg" width="1500" height="99">';
            ...
            $image_file = 'custom/modules/quotes/567f1.jpg';
            $this->Image($image_file, '', '', 180, 12, '', '', 'F', false, 300, '', false, false, 0, false, false, false);
            $options = array(
            "isheader"=>false
            );
